  ...
  const RowIndicator = ({ row, onSelect, selected }) => {
    ...
    return (
      <Dropdown
        ...
        overlayClassName="dropdownStyling"
      >
        <th
          className={`${
      ...
      <div className="flex flex-col gap-4 h-full overflow-auto">
        {!clearedData && (
          <div className="flex items-center gap-4">
            ...
            <Button danger onClick={handleClearAll} size={"large"} className="font-bold">
              Clear All
            </Button>
          </div>
        )}
          ...
          {clearedData && (
            <div className="flex flex-col items-center justify-center flex-1">
              <Empty
                ...
                description={<span style={{ color: "#1677FF" }}>CSV has no data</span>}
              />
            </div>
          )}
        </div>
